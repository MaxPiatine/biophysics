...
#5e-10 #-17      #m^2/s from Ban's paper
dx_ref = 1e-5 #m
D2 =0.001*D
D3 =0.001*D
...
P_K_L = 20.0e-3
P_K_a_L=P_K_L#*(1+1/3)	#um^3 / s		leak potassium permeability
P_K_p_L = P_K_L

P_Cl_L = 2.5e-3
P_Cl_a_L = 2.5e-3#30e-3# 2.5e-3#P_Cl_L			#um^3 / s		leak chlroide permeability
P_Cl_p_L = 2.5e-3#P_Cl_L
...
#impermeant cation concentration = 5 mM
#N_a_cations =10000
#N_p_cations = 10000
...
N_a_anions =290500 # -(((V_desired * C_a) / F) + N_Cl_a_init - N_Na_a_init - N_K_a_init - N_a_cations)	#fmol	Intracellular amount of impermeant anions
N_p_anions =290500
#mobile anions
xm1 =0.5
xm2 =0.5

m_a_anions = xm1 * N_a_anions
im_a_anions = (1-xm1) * N_a_anions
m_p_anions = xm2 * N_p_anions
im_p_anions = (1-xm2) * N_p_anions

'print("  N_a_anions =", str(N_a_anions)  + "  N_p_anions =", str(N_p_anions))'
